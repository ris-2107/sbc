...
const Founder = () => (
  <Stack direction={['column', 'row']} spacing={['4', '14']} padding={'8'}>
    <VStack>
      ...
      <Text children={'BMScE'} opacity={'0.7'} />
    </VStack>
    ...
    <Container maxW={'container.lg'} padding="14" boxShadow={'lg'}>
      ...
      <Stack m={'8'} direction={['column', 'row']} alignItems="center">
        <Text fontFamily={'cursive'} m="7" textAlign={['center', 'left']}>
          Hi, Welcome to BMSEdu! We are glad that you visited.
          BMSEdu is a community driven platform where BMS studeents,teacher and other staff members can
